...
const InternetSpeedChecker = () => {
    const [downloadSpeed, setDownloadSpeed] = reactExports.useState(0);
    const [uploadSpeed, setUploadSpeed] = reactExports.useState(0);
    reactExports.useState("bps"); // Initial unit is bps
    ...
    const measureDownloadSpeed = () => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
    ...
    const measureUploadSpeed = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (React.createElement("div", { className: "fixed bottom-0 w-11/12 lg:w-5/12 px-5 pb-4" },
        React.createElement("div", { className: "flex justify-between items-center" },
            React.createElement("p", { className: "text-left text-zinc-400 font-light text-xs inline-flex items-center" },
                React.createElement(ArrowDownToLine, { className: "mr-1 w-3 h-auto" }),
                " ",
                convertSpeed(downloadSpeed).value.toFixed(2),
                " ",
                convertSpeed(downloadSpeed).unit),
            React.createElement("p", { className: "text-right text-zinc-400 font-light text-xs inline-flex items-center" },
                React.createElement(ArrowUpToLine, { className: "mr-1 w-3 h-auto" }),
                " ",
                convertSpeed(uploadSpeed).value.toFixed(2),
                " ",
                convertSpeed(uploadSpeed).unit))));
};

exports.InternetSpeedChecker = InternetSpeedChecker;
